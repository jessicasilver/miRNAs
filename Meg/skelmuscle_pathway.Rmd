...
dotplot(preV3h_gseGO, showCategory=10, split=".sign",
        label_format = 40,
        font.size = 10,) +
        facet_grid(.~.sign) + 
...
emapplot(pairwise_termsim(preV3h_gseGO), showCategory = 15, layout = "circle") +
  ggtitle("Enrichment map plot of DE Genes (3hr post vs Pre exercise)") +
  theme(plot.title=element_text(hjust=0.5, size = 20, face = "bold"))


ridgeplot(preV3h_gseGO, showCategory = 15) + 
...
# plot results
dotplot(preVpost_gseGO, showCategory=10, split=".sign",
        label_format = 40,
        font.size = 10,) +
        facet_grid(.~.sign) + 
...
emapplot(pairwise_termsim(preVpost_gseGO), showCategory = 15, layout = "circle") +
  ggtitle("Enrichment map plot of DE Genes (Post vs Pre exercise)") +
  theme(plot.title=element_text(hjust=0.5, size = 20, face = "bold"))


ridgeplot(preVpost_gseGO, showCategory = 15) + 
  labs(title = "Density plots of fold change frequency values per gene within each set",
